...
async function runTest() {
    ...
    const system = new index_1.CognitiveSystem();
    const insightService = new insight_1.InsightService();
    try {
        ...
        const followUpResult = await system.processTextInput("The clear blue sky makes me feel peaceful and calm.");
        logger.info({
